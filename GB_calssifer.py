...
def create_x(df, is_train):
    # fill mising value with next valid sample
...
if __name__ == '__main__':
    ...
    rf = GradientBoostingClassifier(n_estimators=500, min_samples_split=2, min_samples_leaf=4, max_depth=80,
                                    random_state=42) # 0.5813121361665429 best wit RF_regressor
    ...
    print("start fitting Gradient Boosting ...")
